...
if(isset($_POST['add_product'])){
   ...
   $p_image_folder = 'project_images/Men_section'.$p_image;
...
if(isset($_POST['update_product'])){
   ...
   $update_p_image_folder = 'project_images/Men_section'.$update_p_image;
...
<header class="header">
 <!-- <link rel="stylsheet" href="css/style.css"/> -->
   <div class="flex">
      ...
      <a href="cart.php" class="cart cart-none">cart :<span><?php echo $row_count; ?></span> </a>
...
<section class="display-product-table">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            <td><img src="project_images/Men_section/<?php echo $row['image']; ?>" height="100" alt=""></td>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <img src="project_images/Men_section/<?php echo $fetch_edit['image']; ?>" height="200" alt="">
